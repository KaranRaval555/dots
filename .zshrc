...
# set up prompt
NEWLINE=$'\n'
PROMPT="${NEWLINE}%K{#88C0D0}%F{#2E3440} λ %K{#2E3440}%F{#E5E9F0} $(date +%_I:%M%P) %K{#3b4252}%F{#ECEFF4} %n %K{#4c566a}%F{#ECEFF4} %~ %f%k ❯ "
...
function command_not_found_handler {
    ...
    printf 'zsh: command not found: %sn' "$1"
...
alias fzf='fzf -m --preview="bat --color=always --style=numbers --line-range=:500 {}" --bind "enter:become(nvim {+})"'
alias ..='cd ..'
alias ...='cd ../..'
